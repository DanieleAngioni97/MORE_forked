folder='MORE_EXP'
load_dir='logs/MORE_EXP--ds-cifar10--model-deitadapter_more'
...
# python run.py --model deitadapter_more --n_tasks 5 --dataset cifar10 --adapter_latent 64 --optim sgd --use_md --compute_auc --buffer_size 200 --folder $folder --load_dir $load_dir testing_useMD.txt --use_buffer --load_task_id 4 --class_order 0
